...
class Hackathon(models.Model):
    ...
    image1 = models.CharField(max_length=250,blank=True,null=False)
    image2 = models.CharField(max_length=250,blank=True,null=False)
    image3 = models.CharField(max_length=250,blank=True,null=False)
    image4 = models.CharField(max_length=250,blank=True,null=False)
    image5 = models.CharField(max_length=250,blank=True,null=False)
