                ...
                modified_data.append(
                    {
                        ...
                        'team_size': [hackathon.team_size_min,hackathon.team_size_max] if hackathon.team_size_min and hackathon.team_size_max else [hackathon.team_size_min],
...
def defaultpage(request, id):
    try:
        ...
        hackathon_major_data = {
            ...
            "team_size":[hackathon_main_serializer.data.get('team_size_min'),hackathon_main_serializer.data.get('team_size_max')] if hackathon_main_serializer.data.get('team_size_min') and hackathon_main_serializer.data.get('team_size_max') else [hackathon_main_serializer.data.get('team_size_min')],
