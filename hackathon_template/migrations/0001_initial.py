# Generated by Django 5.0 on 2024-05-15 18:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('border_radius', models.DecimalField(blank=True, decimal_places=2, max_digits=4)),
                ('box_shadow_color', models.CharField(blank=True, max_length=200)),
                ('blur_radius', models.DecimalField(blank=True, decimal_places=2, max_digits=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hackathon', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='hackathon_template.hackathon')),
            ],
        ),
        migrations.AddField(
            model_name='container',
            name='hackathon',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='hackathon_template.hackathon'),
        ),
        migrations.CreateModel(
            name='HackathonViews',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='hackathon_template.field')),
            ],
        ),
    ]
